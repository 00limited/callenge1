...
//   openModalRegister,
//   openModalLogin,
// } from "../redux/actions/modal_actions";
...
//                           <Button
//                             onClick={this.dropdownMenu}
//                             className={classes.buttonMenuProfile}
//                           >
...
//                           <Button
//                             onClick={this.dropdownMenu}
//                             className={classes.buttonMenuPay}
//                           >
...
//                         <Link className={classes.Link} to="/">
//                           <Button
//                             onClick={this.logutAccount}
//                             className={classes.buttonMenuLogout}
//                           >
...
//                     <Avatar
//                       alt="Lisa Pacar Elco"
//                       src="https://i.imgur.com/woAAzCF.jpg"
//                       className={classes.Avatar}
//                     />
//                   </Button>
//                   {this.state.isMenu ? (
...
//                           <Button
//                             onClick={this.dropdownMenu}
//                             className={classes.buttonMenuFilm}
//                           >
...
//                           <Button
//                             onClick={this.dropdownMenu}
//                             className={classes.buttonMenuReceipt}
//                           >
...
//                         <Link className={classes.Link} to="/">
//                           <Button
//                             onClick={this.logutAdminAccount}
//                             className={classes.buttonMenuLogout}
//                           >
//                             <ExitToApp className={classes.IconMenu} />
//                             <b className={classes.LabelMenu}>Logout</b>
